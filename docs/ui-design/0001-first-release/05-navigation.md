...
- 許可（ヘルスケア、通知、カメラ）は、それが要る操作の中で求める。ヘルスケアの読み取りは初めて体重を入れるときか目標を立てるとき、書き込みは初めて食事を記録したあと、通知は初めて体重を記録したあと、カメラは初めて「撮る」を押したとき。カメラの許可が済むまでは、「記録する」にはファインダーではなく「撮る」を置く
